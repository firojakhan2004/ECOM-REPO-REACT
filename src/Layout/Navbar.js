        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a
                  class={`nav-link ${checkActive("home") ? "active" : ""}`}
                  aria-current="page"
              ...
              <li class="nav-item">
                <a
                  class={`nav-link ${checkActive("about") ? "active" : ""}`}
                  aria-current="page"
              ...
              <li class="nav-item">
                <a
                  class={`nav-link ${checkActive("contact") ? "active" : ""}`}
                  aria-current="page"
              ...
              <li class="nav-item">
                <a
                  class={`nav-link ${checkActive("myorders") ? "active" : ""}`}
                  aria-current="page"
            ...
            >
              <i class="fa" style={{ fontSize: "30px" }}>
                &#xf07a;
              </i>
