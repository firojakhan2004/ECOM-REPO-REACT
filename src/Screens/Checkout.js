...
const CheckoutPage = () => {
  ...
  const handleCheckout = () => {
    ...
    setLoading(true);
    axios
      .post(Base_URL + "purchase_order", dt)
      .then((res) => {
              ...
              <div class="card" style={{ width: "100%" }}>
                <div class="card-body">
                  <h5 class="card-title" style={{ textAlign: "left" }}>
                    Order Summary ({state.length} Items)
                  </h5>
                  <hr></hr>
                  <p class="card-text">
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-sm">Delivary Charge</div>
                      <div class="col-sm" style={{ textAlign: "right" }}>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm" style={{ textAlign: "right" }}>
                        ...
                        {Number(getSubtotal().toFixed(2)) +
                          Number((getSubtotal() / 1000).toFixed(2))}
                      </div>
                    </div>
                    <hr></hr>
                    <div class="row">
                      ...
                      <div
                        class="col-sm"
                        style={{ textAlign: "right", color: "brown" }}
                      >
                        <h4>
                          &#8377;{" "}
                          {Number(getSubtotal().toFixed(2)) +
