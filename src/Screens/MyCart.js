...
function MyCart() {
  ...
  function getMyCart() {
    axios
      .get(Base_URL + "get-my-detailed-cart", { params: { u_id: u_id } })
      .then((result) => {
      ...
      total =
        ...
        parseInt(
          Number(tmp[i].p_data.price) -
            Number(tmp[i].p_data.price) * (Number(tmp[i].p_data.discount) / 100)
        ) *
          tmp[i].quantity;
      console.log(total);
    }
  ...
  const handleQunaIncre = (x, y) => {
    ...
    axios
      .post(Base_URL + "update-quantity", dy)
      .then((res) => {
              ...
              {cartData.map((el, i) => (
                <div class="row" style={{ padding: 5 }}>
                  ...
                  <div class="col-sm-8">
                    ...
                    <p class="card-title" style={{ fontSize: 20 }}>
                      ...
                      <div class="row">
                        <div class="col-sm-5" style={{ textAlign: "right" }}>
                          <button
                            ...
                            onClick={() => {
                              handleQunaDecre(el._id, el.quantity);
                            }}
                        ...
                        <div class="col-sm-5">
                          <button
                            ...
                            onClick={() => {
                              handleQunaIncre(el._id, el.quantity);
                            }}
                            style={{ fontSize: 20, fontWeight: "bold" }}
                          >
                            +
